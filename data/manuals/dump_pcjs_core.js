// This is special helper-hack javascript to extract RAM image from PCJS PDP11 emulator.
// Usage: start emulator, break it, press F12 in browser, go to "console" and paste this file.
// (sometimes need to enter "allow pasting" to enable copy-paste of script).
// After some time, you'll download text memory dump. Use any software to convert it
// to real binary dump. (see: textdump2bin.c in same folder).
// Why? Becaue PCJS emulator's developer do not show option to dump PDP11 all RAM.
// idea (c)2026 by http://www.vabolis.lt ,[script generated by AI].
