...
public class VT52Terminal3oldThread extends GhidraScript {
    ...
    static class VT52Screen implements Runnable {
        ...
        private void putCharProcessed(int r0) {
			...
			//else if (r0 == 0x01) putRawChar('\u0428'); // confirmed: big-font glyph, renders as ? in this logo-drawing context
    ...
    public void run() throws Exception {
        ...
        bottom.add(forceXcsrButton, BorderLayout.NORTH);
        ...
        while (windowOpen[0] && !monitor.isCancelled()) {
